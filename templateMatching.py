...
picture = cv2.imread("1.jpg", 0)
templateOriginal = cv2.imread("CROWNTEMPLATE.png", 0)
templateRotate90 = cv2.rotate(cv2.imread("CROWNTEMPLATE.png", 0), cv2.ROTATE_90_CLOCKWISE)
templateRotate180 = cv2.rotate(cv2.imread("CROWNTEMPLATE.png", 0), cv2.ROTATE_180)
templateRotate270 = cv2.rotate(cv2.imread("CROWNTEMPLATE.png", 0), cv2.ROTATE_90_COUNTERCLOCKWISE)
